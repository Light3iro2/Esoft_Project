    ...
    public partial class FormAuthorization : Form
    {
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!key)
                {
                    MessageBox.Show("Проверьте данные", "Пользователль не найден", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    textBoxLogin.Text = "";
        ...
        private void button1_Cancel(object sender, EventArgs e)
        {
            Application.Exit();
        }
    }
